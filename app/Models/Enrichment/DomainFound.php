...
class DomainFound extends \Sentrion\Models\Enrichment\Base {
    ...
    public function init(array $data): void {
        ...
        if (($this->ip && !sentrion('utils')->conversion->filterIp($this->ip)) || !$this->validateDates($dates)) {
    ...
    public function updateEntityInDb(int $entityId, int $apiKey): void {
        ...
        sentrion('models')->domain->execQuery($query, $params);
    }
}
