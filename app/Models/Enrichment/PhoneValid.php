...
class PhoneValid extends \Sentrion\Models\Enrichment\Base {
    ...
    public function updateEntityInDb(int $entityId, int $apiKey): void {
        ...
        if ($this->iso_country_code !== null) {
            $this->country_code = sentrion('models')->country->getCountryIdByIso($this->iso_country_code);
        }
        ...
        sentrion('models')->phone->execQuery($query, $params);
    }
}
