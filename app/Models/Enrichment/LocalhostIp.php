...
class LocalhostIp extends \Sentrion\Models\Enrichment\Base {
    ...
    public function init(array $data): void {
        ...
        if (!sentrion('utils')->conversion->filterIp($this->ip) || $data['error'] !== sentrion('utils')->constants->ENRICHMENT_IP_IS_BOGON) {
