...
class FieldAudit extends \Sentrion\Models\Base implements \Sentrion\Interfaces\ApiKeyAccessAuthorizationInterface {
    protected string $tableName = 'event_field_audit';
