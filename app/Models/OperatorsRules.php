...
class OperatorsRules extends \Sentrion\Models\Base {
    protected string $tableName = 'dshb_operators_rules';

    public function getAllValidRulesByOperator(int $apiKey): array {
        $params = [
            ':api_key'          => $apiKey,
            ':primary_rule_set' => sentrion('utils')->constants->PRIMARY_RULES_SET_ID,
        ];
    ...
    public function getRuleWithOperatorValue(string $ruleUid, int $apiKey): array {
        $params = [
            ':api_key'  => $apiKey,
            ':uid'      => $ruleUid,
            ':set_id'   => sentrion('utils')->constants->PRIMARY_RULES_SET_ID,
        ];
    ...
    public function getActiveSets(int $apiKey): array {
        ...
        $primaryRulesSetId = sentrion('utils')->constants->PRIMARY_RULES_SET_ID;
