...
class Users extends Base {
    ...
    private function getFirstLine(int $apiKey): array {
        ...
        $params = [
            ...
            ':high_inf'     => sentrion('utils')->constants->USER_HIGH_SCORE_INF,
            //':high_sup'     => sentrion('utils')->constants->USER_HIGH_SCORE_SUP,
            ':med_inf'      => sentrion('utils')->constants->USER_MEDIUM_SCORE_INF,
            ':med_sup'      => sentrion('utils')->constants->USER_MEDIUM_SCORE_SUP,
            ':low_inf'      => sentrion('utils')->constants->USER_LOW_SCORE_INF,
            ':low_sup'      => sentrion('utils')->constants->USER_LOW_SCORE_SUP,
        ];
