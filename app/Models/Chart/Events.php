...
class Events extends Base {
    ...
    private function getFirstLine(int $apiKey): array {
        ...
        [$alertTypesParams, $alertFlatIds]      = $this->getArrayPlaceholders(sentrion('utils')->constants->ALERT_EVENT_TYPES, 'alert');
        [$editTypesParams, $editFlatIds]        = $this->getArrayPlaceholders(sentrion('utils')->constants->EDITING_EVENT_TYPES, 'edit');
        [$normalTypesParams, $normalFlatIds]    = $this->getArrayPlaceholders(sentrion('utils')->constants->NORMAL_EVENT_TYPES, 'normal');
        $params = [
            ':api_key'      => $apiKey,
