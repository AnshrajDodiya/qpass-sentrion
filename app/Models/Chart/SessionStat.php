...
class SessionStat extends Base {
    public function getData(int $apiKey): array {
        ...
        $datesRange = sentrion('utils')->dateRange->getLatestNDatesRangeFromRequest(14, $offset);
    ...
    protected function executeOnRangeById(string $query, int $apiKey): array {
        ...
        $dateRange = sentrion('utils')->dateRange->getLatestNDatesRangeFromRequest(14);
        $offset = sentrion('utils')->timezones->getCurrentOperatorOffset();
        ...
        $params = [
            ...
            ':resolution'   => sentrion('utils')->constants->SECONDS_IN_DAY,
