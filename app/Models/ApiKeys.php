...
class ApiKeys extends \Sentrion\Models\Base {
    ...
    public function insertRecord(string $skipEnrichingAttr, bool $skipBlacklistSync, int $operatorId): int {
        $quote = sentrion('storage')->get('DEFAULT_API_KEY_QUOTE');
        ...
        $params = [
            ...
            ':key'                  => sentrion('utils')->access->saltHash($uuid),
        ];
    ...
    public function enrichableAttributes(int $keyId): array {
        ...
        $attributes = sentrion('utils')->constants->ENRICHING_ATTRIBUTES;
