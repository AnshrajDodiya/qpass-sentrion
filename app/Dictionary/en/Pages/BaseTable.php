...
return [
    ...
    'Base_table_column_user_registered_tooltip' => 'The date of entity account creation in a client platform. If not set, the date of the first recorded entity event.',
    'Base_table_column_userid' => 'Entity ID',
    'Base_table_column_userid_tooltip' => 'Entity identifier provided by a client platform.',
    'Base_table_column_user_firstname' => 'First name',
    'Base_table_column_user_firstname_tooltip' => 'An entity\'s first name.',
    'Base_table_column_user_lastname' => 'Last name',
    'Base_table_column_user_lastname_tooltip' => 'An entity\'s last name.',
    'Base_table_column_user_risk_score_and_email' => 'Trust score & email',
    'Base_table_column_user_risk_score_and_email_tooltip' => 'Displays two values. The trust score on the left side is a calculated per-user value. It ranges from 0 (lowest trust) to 99 (highest trust). The value on the right side is an entity email provided by a client platform.',
    'Base_table_column_session' => 'Session',
    'Base_table_column_session_tooltip' => 'Session parameters.',
    'Base_table_column_user_email' => 'Email',
    'Base_table_column_user_email_tooltip' => 'An entity\'s email address.',
    ...
    'Base_table_column_total_users' => 'Entities',
    'Base_table_column_total_users_tooltip_ips' => 'The total number of entities associated with an IP address.',
    'Base_table_column_total_users_tooltip_countries' => 'The number of entities with IP addresses geolocated to a country over the specified and preceding period.',
    'Base_table_column_total_users_tooltip_domains' => 'The total number of entities with email addresses belonging to a domain.',
    'Base_table_column_total_users_tooltip_isps' => 'The number of ISP-associated entities over the specified and preceding period.',
    'Base_table_column_total_users_tooltip_resources' => 'The number of entities that requested a resource over the specified and preceding period.',
    'Base_table_column_total_users_tooltip_phones' => 'The total number of entities associated with a phone number.',
    'Base_table_column_total_users_tooltip_field_audit' => 'The total number of entities that performed a change to a field.',
    'Base_table_column_total_users_tooltip_user_agent' => 'The total number of entities that used a device.',
    ...
    'Base_table_column_total_edits_tooltip_resources' => 'The number of edits made on a resource over the specified and preceding period.',
    ...
    'Base_table_column_total_actions_tooltip_users' => 'The total number of requests made by an entity.',
    ...
    'Base_table_column_ip_shared_tooltip' => 'Multiple entities detected on the same IP address.',
    ...
    'Base_table_column_ip_vpn_tooltip' => 'IP addresses are used to hide entity\'s real location or to bypass regional blocking.',
    ...
    'Base_table_column_total_ips_tooltip' => 'Total IP addresses associated with entity.',
    'Base_table_column_total_isps' => 'ISPs',
    'Base_table_column_total_isps_tooltip' => 'Total ISPs associated with entity.',
    'Base_table_column_total_countries_tooltip' => 'Total countries associated with entity IP addresses.',
    'Base_table_column_total_user_agents' => 'User agents',
    'Base_table_column_total_user_agents_tooltip' => 'Total user agents associated with entity.',
    'Base_table_column_total_edits_tooltip' => 'Total edits performed by entity.',
    'Base_table_column_total_events' => 'Events',
    'Base_table_column_total_events_tooltip' => 'Total events performed by entity.',
    'Base_table_column_total_sessions' => 'Sessions',
    'Base_table_column_total_sessions_tooltip' => 'Total sessions performed by entity.',

    'Base_table_column_country' => 'Country',
    'Base_table_column_country_tooltip' => 'An originating country of entity request, geolocated by IP address.',
    ...
    'Base_table_column_lastseen_tooltip_users' => 'The date and time of the last entity request.',

    'Base_table_column_added_to_review' => 'Added to review',
    'Base_table_column_added_to_review_tooltip' => 'The date and time of directing entity to review queue.',
    ...
    'Base_table_column_modified_tooltip' => 'Whether a user agent string is identified as altered by an entity.',
    ...
    'Base_table_column_user_phone_tooltip' => 'An entity\'s phone number.',
    ...
    'Base_table_column_domain_total_accounts_tooltip' => 'The total number of entities that have an email with current domain.',
    ...
    'Base_table_column_reviewed_status_tooltip' => 'An entity can be blacklisted or whitelisted. For putting an entity on a list, open an entity page (by clicking on a table row) and then use the corresponding button in the upper-right corner of the interface.',
    'Base_table_column_action_buttons' => 'Review status',
    'Base_table_column_total_fraud_users' => 'Blacklisted',
    'Base_table_column_total_fraud_users_tooltip' => 'The total number of blacklisted entities.',
    'Base_table_column_latest_decision' => 'Latest decision',
    'Base_table_column_latest_decision_tooltip' => 'The date of the last entity review.',
