...
return [
    ...
    'api_http_endpoint_data_ingestion' => [
        ...
        'Data will appear in sentrion dashboard within approximately one minute.',
    ],
    ...
    'api_form_confirmationMessage' => 'You can use sentrion without a paid subscription or choose to enrich IP data. To learn about enrichment plans and obtain a subscription key, please visit: https://www.sentrion.com/pricing/',
    ...
    'api_manual_reset_key_popup_submit_warning_message' => 'Resetting the Tracking ID will permanently replace current Tracking ID, you will immediately lose ability to use sentrion API with current Tracking ID.',
