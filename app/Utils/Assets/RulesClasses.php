...
class RulesClasses extends Base {
    ...
    protected static function getNamespace(bool $core = true): string {
        return $core ? '\\Sentrion\\Rules\\Core' : '\\Sentrion\\Rules\\Custom';
    }
    ...
    public static function getSingleRuleObject(string $uid, ?\Ruler\RuleBuilder $ruleBuilder): ?\Sentrion\Assets\Rule {
        $obj = null;
        $cores = [false, true];
        ...
        foreach ($cores as $core) {
            ...
            try {
                ...
                sentrion('log')->info('rule file %s not found: %s.', $filename, $e->getMessage());
            }
        }
        ...
        foreach ($iter as $file) {
            if ($file->isFile() && $file->getExtension() === 'php') {
                ...
                try {
                    ...
                    $failed[] = $name;
                    sentrion('log')->info('rule file %s not found: %s.', $file->getFilename(), $e->getMessage());
                }
            }
        }
