...
class Constants {
    ...
    protected function init(): void {
        ...
        $assetsConstants = sentrion('assets')->serverConstants->getConstantsObj();
        ...
        foreach ($vars as $key => $value) {
            ...
            if (!sentrion('router')->exists($storageKey)) {
                continue;
            }

            $storageValue = sentrion('storage')->get($storageKey);
    ...
    protected string $PAGE_TITLE_POSTFIX = '| sentrion';
    ...
    protected array $TOP_TEN_MODELS_MAP = [
        'mostActiveUsers'           => \Sentrion\Models\TopTen\UsersByEvents::class,
        'mostActiveCountries'       => \Sentrion\Models\TopTen\CountriesByUsers::class,
        'mostActiveUrls'            => \Sentrion\Models\TopTen\ResourcesByUsers::class,
        'ipsWithTheMostUsers'       => \Sentrion\Models\TopTen\IpsByUsers::class,
        'usersWithMostLoginFail'    => \Sentrion\Models\TopTen\UsersByLoginFail::class,
        'usersWithMostIps'          => \Sentrion\Models\TopTen\UsersByIps::class,
    ];

    protected array $RULES_TOTALS_MODELS = [
        \Sentrion\Models\Phone::class,
        \Sentrion\Models\Ip::class,
        \Sentrion\Models\Session::class,
        \Sentrion\Models\User::class,
    ];

    protected array $REST_TOTALS_MODELS = [
        'isp'       => \Sentrion\Models\Isp::class,
        'resource'  => \Sentrion\Models\Resource::class,
        'domain'    => \Sentrion\Models\Domain::class,
        'device'    => \Sentrion\Models\Device::class,
        'country'   => \Sentrion\Models\Country::class,
        'field'     => \Sentrion\Models\FieldAudit::class,
    ];

    protected array $ENRICHING_ATTRIBUTES = [
        'ip'        => \Sentrion\Models\Ip::class,
        'email'     => \Sentrion\Models\Email::class,
        'domain'    => \Sentrion\Models\Domain::class,
        'phone'     => \Sentrion\Models\Phone::class,
        //'ua'        => \Sentrion\Models\Device::class,
    ];
