...
class StreamTransport {
    ...
    public static function request(\Sentrion\Entities\HttpRequest $request): \Sentrion\Entities\HttpResponse {
        ...
        if ($raw === null) {
            $result = sentrion('entities')->httpResponse->failure($code, 'stream_request_failed', $respHeaders);

            return $result;
        }

        return sentrion('entities')->httpResponse->success($code, $raw, $respHeaders);
    }
