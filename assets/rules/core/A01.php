...
class A01 extends \Sentrion\Assets\Rule {
    ...
    protected function prepareParams(array $params): array {
        $maximumAttempts = sentrion('utils')->constants->RULE_MAXIMUM_NUMBER_OF_LOGIN_ATTEMPTS;
        $loginFail = sentrion('utils')->constants->ACCOUNT_LOGIN_FAIL_EVENT_TYPE_ID;
        $windowSize = sentrion('utils')->constants->RULE_LOGIN_ATTEMPTS_WINDOW;
