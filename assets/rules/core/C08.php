...
class C08 extends \Sentrion\Assets\Rule {
    ...
    protected function prepareParams(array $params): array {
        $params['eip_has_specific_country'] = in_array(sentrion('utils')->constants->COUNTRY_CODE_SOUTH_AFRICA, $params['eip_country_id']);
