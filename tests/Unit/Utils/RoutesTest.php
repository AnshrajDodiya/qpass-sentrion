...
use Sentrion\Utils\Routes;
use PHPUnit\Framework\TestCase;

/**
 * Unit tests for Sentrion\Utils\Routes.
 *
 * Covered:
 ...
 *       resolving can be isolated from sentrion('session') and sentrion('entities').
 *
 * @todo Cover Routes::setCurrentRequestApiKey() and
 *       Routes::getCurrentSessionApiKey() after current session API key
 *       resolving can be isolated from sentrion('session'), TEST_API_KEY_ID
 *       and sentrion('entities').
 */
final class RoutesTest extends TestCase {
    ...
    public function testGetCurrentRequestOperatorReturnsStoredValue(): void {
        $operator = $this->createStub(\Sentrion\Entities\Operator::class);
