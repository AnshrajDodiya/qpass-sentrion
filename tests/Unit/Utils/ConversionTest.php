...
use Sentrion\Utils\Conversion;
use Base;
use PHPUnit\Framework\TestCase;

/**
 * Unit tests for Sentrion\Utils\Conversion.
 *
 * Covered:
 * - Conversion::intVal()
 ...
 * - request helpers through sentrion('request') / sentrion('storage')
 */
final class ConversionTest extends TestCase {
    ...
    protected function setUp(): void {
        ...
        sentrion('request')->resetPayloadCache();
    }
