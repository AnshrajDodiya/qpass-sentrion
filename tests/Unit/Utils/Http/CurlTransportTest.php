...
use Sentrion\Utils\Http\CurlTransport;
 ...
 *   - depends on entity factories returned by sentrion('entities')
 ...
 * - inject HttpResponse factory instead of using sentrion('entities')
