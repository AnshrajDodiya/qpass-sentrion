...
use Sentrion\Utils\Access;
use Sentrion\Utils\ErrorCodes;
use PHPUnit\Framework\TestCase;

/**
 * Unit tests for Sentrion\Utils\Access.
 *
 * Covered:
 ...
 *       sentrion('utils')->variables static proxy into a replaceable dependency.
 *
 ...
 *       resolving is isolated from sentrion('utils')->routes static proxy.
 *
 ...
 *       pepper resolving is extracted from sentrion('utils')->variables static proxy
...
final class AccessTest extends TestCase {
    protected function tearDown(): void {
        sentrion('session')->remove('csrf');
        sentrion('storage')->remove('SALT');
    ...
    public function testCSRFTokenValid(
        ...
        sentrion('session')->set('csrf', $sessionCsrf);
    ...
    public function testSaltHashUsesStorageSaltAndIsDeterministic(): void {
        ...
        sentrion('storage')->set('SALT', $salt);
